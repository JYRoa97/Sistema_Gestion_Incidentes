...
$incidentes = $inci->consultar_todas();
?>
<div class="container">
    <div class="row">
        <div class="col-12">
                ...
                <div class="card-body">
                    <table class="table table-striped table-hover" >
                        ...
                        foreach ($incidentes as $incidente){
                            ...
                            if($incidente->getEstado()==1){
                                echo "<td>"."<span><a href='index.php?pid=".base64_encode('presentacion/administrador/asignar/tecnico.php')."&id=".$incidente->getId()."'><span  style='color: green' class='fas fa-user-plus fa-2x' data-toggle='tooltip' data-placement='top' title='Asignar tecnico al incidente' ></span></a>"."</td>";
                            }else if($incidente->getEstado()==2 or $incidente->getEstado()==3){
